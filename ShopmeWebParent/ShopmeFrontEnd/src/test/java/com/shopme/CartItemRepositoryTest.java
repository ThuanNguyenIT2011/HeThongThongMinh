...
public class CartItemRepositoryTest {
	...
	public void testGetCartByCustomer() {
		...
		List<CartItem> listCartItems = repo.findByCustomerID(customer.getId());
//		List<CartItem> listCartItems = repo.findByCustomer(customer);
		listCartItems.forEach(ele -> {
			System.out.println("quantity: " + ele.getQuantity());
		});
		
//		assertThat(listCartItems.size()).isGreaterThan(0);
	}
